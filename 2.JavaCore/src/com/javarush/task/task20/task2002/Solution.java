...
//              моє рішення, яке не приймає валідатор
//            PrintWriter printWriter = new PrintWriter(outputStream);
//            for (User user: users) {
//                String firstName = (user.getFirstName() != null) ? "yes" : "no";
//                printWriter.println(firstName);
//                if (user.getFirstName() != null)
//                    printWriter.println(user.getFirstName());
//                String lastName = (user.getLastName() != null) ? "yes" : "no";
//                printWriter.println(lastName);
//                if (user.getLastName() != null)
//                    printWriter.println(user.getLastName());
//                String birthday = (user.getBirthDate() != null) ? "yes" : "no";
//                printWriter.println(birthday);
//                if (user.getBirthDate() != null)
//                    printWriter.println(user.getBirthDate());
//                    printWriter.println(user.isMale());
//                String country = (user.getCountry() != null) ? "yes" : "no";
